...
def frequency_grid(
    ...
    if number_of_periods < 1:
        flag = -1
        # return flag
        # raise ValueError("no physical orbital periods within constraints")
    ...
    if number_of_periods < MINIMUM_PERIOD_GRID_SIZE:
        ...
        # if time_span < 5:
            # time_span = 5
        warnings.warn(
            "given stellar density yielded grid with too few values"
        )
        # return -2
        # raise ValueError(f"too few grid points ({number_of_periods})")
...
if __name__ == "__main__":
    ...
    # f_x, params = frequency_grid(R_star=1, M_star=1, time_span=734, period_max=16)
    # print(f_x)
    # print(len(f_x), f_x)
